...
```bash
python .Codex/skills/workflow-author/scripts/create_workflow.py <workflow-slug>
```
...
```bash
echo "My workflow description" | python .Codex/skills/workflow-author/scripts/create_workflow.py <workflow-slug>
python .Codex/skills/workflow-author/scripts/create_workflow.py <workflow-slug> --description "My workflow description"
```
...
- Never hardcode model IDs like `"xai/grok-4.1-fast-reasoning"` or `"anthropic/Codex-haiku-4.5"` in workflow code
